...
plt.axis("equal")
plt.tight_layout()
plt.savefig("img/Norms_Stokes_Sag_Flux.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("img/Norms_Stokes_Sag_Flux_distribution.png")
plt.show()
...
plt.axis("equal")
plt.tight_layout()
plt.savefig("img/Norms_Stokes_Sag_Flux_normalized.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("img/Angular_Error_Distribution.png")
plt.show()
